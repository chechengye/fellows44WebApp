<%@ page import="web06.pojo.Product" %>
...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<%
			List<Product> productList = (List<Product> )pageContext.findAttribute("productList");
			for(Product p : productList){
			    out.write("<div style='height:240px' class=\"col-md-2\">");
